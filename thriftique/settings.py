"""
Django settings for thriftique project.
...
WSGI_APPLICATION = 'thriftique.wsgi.application'
...
#Custom user model for accounts folder config in models.py
