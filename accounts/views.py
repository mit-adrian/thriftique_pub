...
# Custom decorator - Restrict the user from accessing unauthorized pages
...
def registerVendor(request):
    if request.user.is_authenticated:
        ...
        if form.is_valid() and v_form.is_valid():
            ...
            vendor.save()
            #Sending verification email to vendors
            mail_subject = 'Please activate your account'
            email_template = 'accounts/emails/account_verification_email.html'
            send_verification_email(request, user, mail_subject, email_template)
            #Sending verification email to vendors
            messages.success(request, 'Your account has been registered successfully! Please wait for the system approval. Thank you!')
